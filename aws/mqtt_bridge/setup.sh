...
# Create certs
aws --region ${AWS_REGION} iot create-keys-and-certificate --set-as-active --certificate-pem-outfile cert.crt --private-key-outfile private.key --public-key-outfile public.key > ${RESOURCE_FOLDER}/bridge.json
